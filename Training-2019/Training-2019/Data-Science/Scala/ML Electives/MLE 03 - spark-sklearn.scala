...
// MAGIC irisDataRDD = sc.parallelize(zip(iris.target, iris.data), 8)
...
// MAGIC 
// MAGIC for correct, total in sampleResults.collect():
// MAGIC   print(f"{correct}/{total}   {100.0*correct/total:.2f}%")
