...
// MAGIC %md
// MAGIC Let's load the Airbnb dataset, using the same CSV reader arguments we used in the previous DataFrames section.

// COMMAND ----------

val filePath = "dbfs:/mnt/training/airbnb/sf-listings/sf-listings.csv"
...
val outputPath = userhome + "/machine-learning-s/airbnb-cleansed.parquet"
