...
# MAGIC 
# MAGIC 1. Projects have various library dependencies 
# MAGIC   - Shipping a machine learning solution involves the environment in which it was built
# MAGIC   - MLflow allows for this environment to be a conda environment or docker container
# MAGIC   - This means that teams can easily share and publish their code for others to use
# MAGIC 2. Machine learning projects become increasingly complex as time goes on
# MAGIC   - This includes ETL and featurization steps, machine learning models used for pre-processing, and finally the model training itself
# MAGIC 3. Each component of a machine learning pipeline needs to allow for tracing its lineage
# MAGIC   - If there's a failure at some point, tracing the full end-to-end lineage of a model allows for easier debugging.

# COMMAND ----------

# MAGIC %md-sandbox
# MAGIC **ML Projects is a specification for how to organize code in a project.**<br><br>
# MAGIC 
# MAGIC - The heart of this is an **MLproject file,** a YAML specification for the components of the ML project
# MAGIC - This allows for more complex workflows since a project can execute another project
# MAGIC    - This allows for encapsulation of each stage of a more complex machine learning architecture
# MAGIC - This means that teams can collaborate more easily using this architecture
# MAGIC 
...
# MAGIC 
# MAGIC <img alt="Side Note" title="Side Note" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.05em; transform:rotate(15deg)" src="https://files.training.databricks.com/static/images/icon-note.webp"/> We'll uncomment out the `__main__` block when we save this code as a Python file.<br>
