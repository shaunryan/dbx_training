...
model_path =  userhome + "/ml-production/RF_with_preprocess/"
...
# Construct and save the model
model_path =  userhome + "/ml-production/RF_with_postprocess/"
...
# MAGIC %md
# MAGIC ### [Start the Capstone Project.]($../06-Capstone-Project )
