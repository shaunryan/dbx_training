...
# MAGIC 2. The artifact location.  This is where the artifacts are stored in DBFS, which is backed by the Azure blob store
...
# MAGIC 
# MAGIC ### [Click here to start the lab for this lesson.]($./Labs/02-Lab) 
