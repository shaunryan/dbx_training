...
// TODO
val storageAccountName = FILL_IN
val containerName = FILL_IN
val storageEntity = "fs.azure.account.key.%s.blob.core.windows.net".format(storageAccountName)
val accessKey = FILL_IN
