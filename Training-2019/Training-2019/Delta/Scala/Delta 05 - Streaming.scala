...
val dataPath = "dbfs:/mnt/training/definitive-guide/data/activity-data"
...
val writePath = basePath + "/output"
val checkpointPath = writePath + "/_checkpoint"
...
val checkpointPath = activityPath + "/_checkpoint"
...
dbTest("Assertion #1", 3, countsDF.columns.length)
