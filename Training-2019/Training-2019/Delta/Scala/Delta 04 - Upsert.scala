...
val newDataDF = spark.sql("FILL_IN".format(deltaIotPath))
...
// TODO
val sqlCmd = """FILL_IN""".format(databaseName, deltaIotPath)
...
// TODO
val sqlCmd = "FILL_IN".format(databaseName)
val count = spark.sql(sqlCmd).first()[0]
