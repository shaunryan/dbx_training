...
// MAGIC * Databricks Runtime 5.2 or greater
// MAGIC * You will NOT be able to use this on Community Edition, as the MLflow server is not set up for that.
// MAGIC * Some familiarity with Databricks Delta syntax.
// MAGIC 
// MAGIC ## Datasets Used
...
// MAGIC %md-sandbox
// MAGIC ## Cluster and Library Setup
// MAGIC 
// MAGIC This notebook makes use of a service called MLflow (more on this later).
// MAGIC 
// MAGIC You will need to attach the following library to your cluster.
// MAGIC 
// MAGIC 
// MAGIC **Maven**: **`org.mlflow:mlflow-client:1.1.0`**
// MAGIC For more information on how to create and/or install libraries see:
// MAGIC * <a href="https://www.databricks.training/step-by-step/creating-maven-libraries/index.html" target="_blank">Creating a Workspce Library</a>
// MAGIC * <a href="https://www.databricks.training/step-by-step/installing-libraries-from-maven/index.html" target="_blank">Installing a Cluster Library</a> (recomended)
...
// MAGIC %run "./Includes/Classroom-Setup-08"
...
val writePath = basePath + "/output.parquet"   // A subdirectory for our output
val checkpointPath = writePath + "/checkpoint"  // A subdirectory for our checkpoint & W-A logs
...
val streamingQuery = initialDF                  // Start with our "streaming" DataFrame
  ...
  .queryName("stream-1s")                       // Specify Query Name
...
displayHTML(s"""
  <p>RMSE: $rmse</p>
  <p>View the <a href="/?o=${getTagValue("orgId")}#mlflow/experiments/${context.getExperimentId}/runs/${run.getId}" target="_blank">MLflow Run</a> </p>
  <p>View the <a href="/?o=${getTagValue("orgId")}#mlflow/experiments/${context.getExperimentId}" target="_blank">MLflow Experiment</a> </p>
""") 
...
// MAGIC %run "./Includes/Classroom-Cleanup-08"
