...
parquetDataPath  = basePath + "/customer-data/"
...
sqlCmd2 = "SELECT count(*) FROM {}.customer_data".format(databaseName)
...
sqlCmd = "SELECT count(*) FROM {}.customer_data_delta".format(databaseName)
display(spark.sql(sqlCmd))
...
# ANSWER
inventoryDataPath = basePath + "/inventory-data/"
