...
# MAGIC 
# MAGIC **PyPI**: **`mlflow==1.1.0`**
# MAGIC For more information on how to create and/or install libraries see:
# MAGIC * <a href="https://www.databricks.training/step-by-step/creating-pypi-libraries/index.html" target="_blank">Creating a Workspce Library</a>
# MAGIC * <a href="https://www.databricks.training/step-by-step/installing-libraries-from-pypi/index.html" target="_blank">Installing a Cluster Library</a> (recomended)

# COMMAND ----------

# You can uncomment this if you are NOT using ML Runtime
# Otherwise, you will need to attach this to your cluster
# dbutils.library.installPyPI("mlflow", "1.1.0")
...
checkpointPath = writePath + "/checkpoint"  # A subdirectory for our checkpoint & W-A logs
