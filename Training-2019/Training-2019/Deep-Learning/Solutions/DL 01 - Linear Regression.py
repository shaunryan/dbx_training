...
# MAGIC 
# MAGIC In terms of reproducibility, there are some [known limitations](https://keras.io/getting-started/faq/#how-can-i-obtain-reproducible-results-using-keras-during-development).
