...
# MAGIC 
# MAGIC You can see François Chollet's [comment](https://github.com/keras-team/keras/issues/1170) on this issue, recommending to stick with MSE. But for teaching purposes, now you see how to write custom metric functions!
...
filepath = "/dbfs/user/" + username + '/deep-learning/keras_checkpoint_weights.hdf5'
...
# MAGIC ### Tensorboard
# MAGIC 
# MAGIC [Tensorboard](https://www.tensorflow.org/guide/summaries_and_tensorboard) provides a nice UI to visualize and debug your neural networks. We can also define it as a callback.

# COMMAND ----------

from tensorflow.keras.callbacks import TensorBoard

log_dir = username+'_tb.dir'
...
newModel = tf.keras.models.model_from_yaml(yaml_string)
