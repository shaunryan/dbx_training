...
# ANSWER
# There are 650 parameters because 13*50 = 650, and for each neuron in the first hidden layer, there is an associated bias unit, for a total of 700 learnable parameters.
