...
query_endpoint(prod_scoring_uri, sample_input, prod_service_key)
...
def n_samples_azureML(n, df=df):
  ...
  return query_endpoint(scoring_uri=prod_scoring_uri, service_key=prod_service_key, inputs=query_input)
