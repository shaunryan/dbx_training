...
// MAGIC %md
// MAGIC # User Defined Functions Lab
// MAGIC 
// MAGIC **NOTE**: This lab is only available in Python due to the dependency on Python. However, you can complete it using the `math` library in Scala.
// MAGIC 
// MAGIC <br>
...
// MAGIC  - Build a UDF, Vectorized UDF, and benchmark it against using the built-in sqrt method
// MAGIC  
