...
// MAGIC  - Build a UDF and Vectorized UDF in Python, and compare it to a Scala UDF and the built-in method
// MAGIC  - Understand why Vectorized UDFs are more performant than regular Python UDFs
