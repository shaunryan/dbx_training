...
# MAGIC 
# MAGIC *NOTE* This is different than DBIO Caching.
# MAGIC 
# MAGIC ## ![Spark Logo Tiny](https://files.training.databricks.com/images/105/logo_spark_tiny.png) In this lesson you:<br>
# MAGIC  - Analyze the performance of caching RDDs to DataFrames
# MAGIC  - Compare and contrast the various storage level options
...
df = spark.read.csv("/mnt/training/dataframes/people-with-header-10m.txt", header="true", sep=":")
...
df2 = spark.read.csv("/mnt/training/dataframes/people-with-header-10m.txt", header="true", inferSchema="true", sep=":")
...
df3 = spark.read.csv("/mnt/training/dataframes/people-with-header-10m.txt", header="true", inferSchema="true", sep=":")
