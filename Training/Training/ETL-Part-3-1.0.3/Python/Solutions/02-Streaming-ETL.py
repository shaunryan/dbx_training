...
display(kafkaCleanDF, streamName="query_1p")

# Wait until the stream is ready...
untilStreamIsReady("query_1p")
...
display(goeocodingDF, streamName="query_2p")

# Wait until the stream is ready...
untilStreamIsReady("query_2p")
...
display(joinedDF, streamName="query_3p")

# Wait until the stream is ready...
untilStreamIsReady("query_3p")
...
(joinedDF
  ...
  .queryName("query_4p")                         # The name of the stream
  .start()                                       # Start the operation
)
# Wait until the stream is ready...
untilStreamIsReady("query_4p")
