...
# MAGIC %python
# MAGIC dbutils.fs.ls("dbfs:/user/" + username + "/myTableUnmanaged")
...
# MAGIC 
# MAGIC **At the end of this course, please complete the <a href="https://www.surveymonkey.com/r/VYGM9TD" target="_blank">short feedback survey</a>.  Your input is extremely important and shapes future course development.**
