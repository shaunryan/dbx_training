...
# path = "/mnt/training/twitter/firehose/2018/*/*/*/*" # This imports of the data
tweetDF = (spark.read
...
getDomainUDF = sqlContext.udf.register("getDomainUDF", getDomain)
...
# ANSWER
badActorsDF = spark.read.parquet("/mnt/training/twitter/supplemental/badactors.parquet")
