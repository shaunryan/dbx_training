...
dbTest("ET2-S-06-01-01", 7200000, wikiDF.count)
dbTest("ET2-S-06-01-02", Set("timestamp", "site", "requests"), wikiDF.columns.toSet)
...
// TODO
val wikiDF1Partition = // FILL_IN
val wikiDF16Partition = // FILL_IN
val wikiDF128Partition = // FILL_IN

// COMMAND ----------

// TEST - Run this cell to test your solution

dbTest("ET2-S-06-02-01", 1, wikiDF1Partition.rdd.getNumPartitions)
dbTest("ET2-S-06-02-02", 16, wikiDF16Partition.rdd.getNumPartitions)
dbTest("ET2-S-06-02-03", 128, wikiDF128Partition.rdd.getNumPartitions)
...
// TODO
val wikiDF16PartitionCoalesced = // FILL_IN

// COMMAND ----------

// TEST - Run this cell to test your solution

dbTest("ET2-S-06-03-01", 10, wikiDF16PartitionCoalesced.rdd.getNumPartitions)
