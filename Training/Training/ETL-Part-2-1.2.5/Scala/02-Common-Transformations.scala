...
// MAGIC 
// MAGIC <img alt="Hint" title="Hint" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.3em" src="https://files.training.databricks.com/static/images/icon-light-bulb.svg"/>&nbsp;**Hint:** <a href="http://spark.apache.org/docs/latest/api/scala/index.html#org.apache.spark.ml.feature.MinMaxScaler" target="_blank">Also see the built-in class `MinMaxScaler`</a>
...
// MAGIC 
// MAGIC <img alt="Hint" title="Hint" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.3em" src="https://files.training.databricks.com/static/images/icon-light-bulb.svg"/>&nbsp;**Hint:** <a href="http://spark.apache.org/docs/latest/api/scala/index.html#org.apache.spark.ml.feature.Imputer" target="_blank">Also see the built-in class `Imputer`</a>
...
val cols = dupedDF.columns.toSet

dbTest("ET2-S-02-01-01", 103000, dupedDF.count)
dbTest("ET2-S-02-01-02", Set("middleName", "salary", "lastName", "firstName", "birthDate", "gender", "ssn"), cols)
...
// TODO
val dupedWithColsDF = // FILL_IN

// COMMAND ----------

// TEST - Run this cell to test your solution
val cols = dupedWithColsDF.columns.toSet

dbTest("ET2-S-02-02-01", 103000, dupedWithColsDF.count)
dbTest("ET2-S-02-02-02", Set("lcFirstName", "middleName", "ssnNums", "lcMiddleName", "salary", "lcLastName", "lastName", "firstName", "birthDate", "gender", "ssn"), cols)
...
// TODO
val dedupedDF = // FILL_IN

// COMMAND ----------

// TEST - Run this cell to test your solution
val cols = dedupedDF.columns.toSet

dbTest("ET2-S-02-03-01", 100000, dedupedDF.count)
dbTest("ET2-S-02-03-02", Set("middleName", "salary", "lastName", "firstName", "birthDate", "gender", "ssn"), cols)
