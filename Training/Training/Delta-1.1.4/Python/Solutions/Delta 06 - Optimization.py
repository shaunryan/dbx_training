...
# MAGIC %md
# MAGIC <iframe  
# MAGIC src="//fast.wistia.net/embed/iframe/86vcy1wkdy?videoFoam=true"
# MAGIC style="border:1px solid #1cb1c2;"
# MAGIC allowtransparency="true" scrolling="no" class="wistia_embed"
# MAGIC name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen
# MAGIC oallowfullscreen msallowfullscreen width="640" height="360" ></iframe>
# MAGIC <div>
# MAGIC <a target="_blank" href="https://fast.wistia.net/embed/iframe/86vcy1wkdy?seo=false">
...
count = len(dbutils.fs.ls(deltaIotPath + "/date=2018-06-01"))
...
print("File count: {}".format(preNumFiles))
...
print("File count: {}".format(postNumFiles))
