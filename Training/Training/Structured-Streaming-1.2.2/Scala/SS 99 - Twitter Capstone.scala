...
val cleanDF = rawDF
 ...
 .select(
   ...
   $"json.FILL_IN".as("FILL_IN"),                                           // Promote subfields of "json" column e.g. "json.field" to "field"
...
// TODO
val countryCodeDF = spark.read.FILL_IN
...
.FILL_IN                               // Name the query "mappedTable-scala"
