...
// MAGIC     var allHints = document.getElementsByClassName("hint-8575");
// MAGIC     var answer = document.getElementById("answer-8575");
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-8575");
...
// MAGIC           id="hint-button-8575">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-8575" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-6582");
// MAGIC     var answer = document.getElementById("answer-6582");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-6582");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-6582">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-6582" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-7585");
// MAGIC     var answer = document.getElementById("answer-7585");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-7585");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-7585">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-7585" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-5451");
// MAGIC     var answer = document.getElementById("answer-5451");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-5451");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-5451">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-5451" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-2262");
// MAGIC     var answer = document.getElementById("answer-2262");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-2262");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-2262">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-2262" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
