...
// MAGIC     var allHints = document.getElementsByClassName("hint-2436");
// MAGIC     var answer = document.getElementById("answer-2436");
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-2436");
...
// MAGIC           id="hint-button-2436">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-2436" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
...
// MAGIC 0. Spark begins running jobs once we call `start`. This is equivilent to calling an action on a "static" DataFrame.
