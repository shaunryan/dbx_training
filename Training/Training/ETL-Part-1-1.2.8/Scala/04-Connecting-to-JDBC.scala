...
dbTest("ET1-S-04-01-01", 0, dfMin)
dbTest("ET1-S-04-01-02", 214748365087L, dfMax.asInstanceOf[Long])
...
// MAGIC 
// MAGIC <a href="https://docs.databricks.com/spark/latest/data-sources/sql-databases.html#managing-parallelism" target="_blank">Referencing the docs,</a> define the connection parameters for this read.  Use 12 partitions.
// MAGIC 
// MAGIC Save the results to `accountDFParallel`.
// MAGIC 
// MAGIC <img alt="Side Note" title="Side Note" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.05em; transform:rotate(15deg)" src="https://files.training.databricks.com/static/images/icon-note.webp"/> Setting the column for your parallel read introduces unexpected behavior due to a bug in Spark.  To make sure that Spark uses the capitalization of your column, use `""""insertID""""` for your column. <a href="https://github.com/apache/spark/pull/20370#issuecomment-359958843" target="_blank"> Monitor the issue here.</a>

// COMMAND ----------

// TODO
val accountDFParallel = // FILL_IN

// COMMAND ----------

// TEST - Run this cell to test your solution
dbTest("ET1-S-04-02-01", 12, accountDFParallel.rdd.getNumPartitions)
