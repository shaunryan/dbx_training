...
# MAGIC The [first part of the guide](https://docs.azuredatabricks.net/spark/latest/mllib/mlflow.html), **MLflow Quick Start: Model Training and Logging**, focuses on training a model and logging the training metrics, parameters, and model to the MLflow tracking server. 
# MAGIC 
...
# MAGIC       * Source **PyPI** and enter `scikit-learn==0.19.1`.
...
# MAGIC %md ## Deploying the model to production using [Azure Kubernetes Service (AKS)](https://azure.microsoft.com/en-us/services/kubernetes-service/). Do Option 1 or Option 2.
