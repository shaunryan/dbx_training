...
# MAGIC You can use the MLflow API to load the model from the MLflow server that was produced by a given run. To do so, specify the `run_id`.
# MAGIC 
...
pyfunc_udf = mlflow.pyfunc.spark_udf(spark, "model", run_id="6a7ee9e4748f48c88fd06f2e76794d42")
