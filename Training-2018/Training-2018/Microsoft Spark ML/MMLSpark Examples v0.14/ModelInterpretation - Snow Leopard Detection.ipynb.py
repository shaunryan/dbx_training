...
# MAGIC %md ## Automated Snow Leopard Detection with Microsoft ML for Apache Spark
# MAGIC 
# MAGIC <img src="https://mmlspark.blob.core.windows.net/graphics/SnowLeopardAD/SLTrust.PNG" width="900" style="float: right;"/>
...
# MAGIC %md <img src="https://mmlspark.blob.core.windows.net/graphics/SnowLeopardAD/SLPipeline.PNG" width="900" style="float: right;"/>
...
test_image_url = "https://mmlspark.blob.core.windows.net/graphics/SnowLeopardAD/snow_leopard.jpg"
...
# MAGIC %md ### Your results will look like:
# MAGIC <img src="https://mmlspark.blob.core.windows.net/graphics/SnowLeopardAD/lime_results.png" width="900" style="float: right;"/>