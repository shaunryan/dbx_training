...
# MAGIC %md ![Smiley face](https://i.imgur.com/p2KgdYL.jpg)
...
# MAGIC %md ![Resnet 18](https://i.imgur.com/Mb4Dyou.png)

# COMMAND ----------

# MAGIC %md ### How does it work?
# MAGIC 
# MAGIC ![Convolutional network weights](http://i.stack.imgur.com/Hl2H6.png)

# COMMAND ----------

# MAGIC %md ### Run the experiment
