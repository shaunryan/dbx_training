...
var path2018 = FILL_IN   // specify the path to the 2018 parquet "file"
val trx2018DF = FILL_IN  // read in the 2018 parquet file
...
val fast2018DF = FILL_IN // Read in the "fast" parquet file
