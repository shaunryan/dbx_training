...
val partitions =  FILL_IN // create a lit of the partitions to analyse

val statFile18DF = statFileWithPartitions(FILL_IN) // add the correct params
 .FILL_IN                                         // add the "series" column
 .FILL_IN                                         // add the "month" column
 .FILL_IN                                         // sort the results by "month"
 .persist()

val partitionsDiffDF = FILL_IN                     // union the two results together
