...
// MAGIC 
// MAGIC Reguardless of "Should I cache", caching is a viable component of developing Spark applications. 
// MAGIC 
...
// MAGIC 
// MAGIC The feature is planned for, but not yet part of Spark 2.x
// MAGIC 
...
def cacheAs(df:DataFrame, name:String, level:StorageLevel):DataFrame = {
