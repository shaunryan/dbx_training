...
// MAGIC 
// MAGIC Run the following tests and compare the duration of each datatype and their effect on performance
...
// %run "./Worksheets/Data Types & Data Structures - Sample Results"
