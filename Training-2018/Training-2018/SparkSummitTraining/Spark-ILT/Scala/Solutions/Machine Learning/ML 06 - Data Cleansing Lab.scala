...
// ANSWER
dbutils.fs.head("mnt/training/airbnb/sf-listings/sf-listings.csv", 3000)
...
val fixedPriceDF = baseDF
                  ...
                  .withColumn("price", regexp_replace($"price_raw", "[\\$,]", "").cast("Decimal(10,2)"))
...
// ANSWER
val noNullsDF = fixedPriceDF.na.drop(Array("zipcode", "host_is_superhost"))
