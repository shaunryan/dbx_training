...
val iZipCode = new StringIndexer().setInputCol("zipcode").setOutputCol("cat_zipcode").setHandleInvalid("skip")
...
oneHotEnc.setInputCols(Array("cat_neighborhood", "cat_room_type", "cat_zipcode", "cat_property_type", "cat_bed_type"))
oneHotEnc.setOutputCols(Array("vec_neighborhood", "vec_room_type", "vec_zipcode", "vec_property_type", "vec_bed_type"))
