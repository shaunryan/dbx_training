...
// MAGIC ////////////////////////////////////////////////////////////////////////////////
// MAGIC 
// MAGIC     // These are both hacked to work for Summit
// MAGIC     "NorthEurope"      -> (NorthEuropeAcct, NorthEuropeSas),
// MAGIC     "WestEurope"       -> (NorthEuropeAcct, NorthEuropeSas),
// MAGIC     
...
// MAGIC 
// MAGIC   var awsRegion = "us-west-2"
// MAGIC   val (source, extraConfigs) = getAwsMapping(awsRegion)
// MAGIC 
...
// MAGIC 
// MAGIC   var resultMsg = "Unknown error"
// MAGIC   
...
// MAGIC       resultMsg = s"""Datasets are already mounted to <b>$mountDir</b> from <b>$mountSource</b>"""
// MAGIC     } else {
// MAGIC       throw new IllegalStateException(s"""Invalid Mounts: Expected <b>$mountSource</b> but found <b>$mount.source</b>. Please unmount <b>$mountDir</b> and then rerun this command.""")
// MAGIC     }
// MAGIC   } else {
// MAGIC     println(s"""Mounting datasets to <b>$mountDir</b> from <b>$mountSource</b>""")
// MAGIC     mount(source, extraConfigs, mountDir)
// MAGIC     resultMsg = s"""Mounted datasets to <b>$mountDir</b> from <b>$mountSource<b>"""
// MAGIC   }
// MAGIC   
