...
val basePath       = userhome + "/wikipedia-streaming"
val bronzePath     = basePath + "/wikipediaEditsRaw.delta"
val silverPath     = basePath + "/wikipediaEdits.delta"
val goldPath       = basePath + "/wikipediaEditsSummary.delta"
...
// MAGIC %md
// MAGIC Wait until stream is done initializing before running this cell.
...
// MAGIC %md
// MAGIC Wait till stream is done initializing before running this cell.
