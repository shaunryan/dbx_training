...
def FILL_IN(FILL_IN, FILL_IN, FILL_IN):
  return FILL_IN
...
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Grocery
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Restaurant
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Pets/Livestock
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Utilities
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Automotive
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Entertainment
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Drug Store
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Convenience
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # House Hold
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Home Improvement
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Clothing
finalDF = categorize(FILL_IN, FILL_IN, FILL_IN) # Business
...
display(
  finalDF.filter(col("category").isNull())
)
