...
edges = df.select(<FILL_IN>, <FILL_IN>)
...
# TODO: Replace <FILL_IN> with appropriate code
winLossDF = <FILL_IN>.join(<FILL_IN>)
winPercentageDF = winLossDF.selectExpr(<FILL_IN>)
...
# TODO
shortest_path = g.shortestPaths(['<FILL_IN>'])
