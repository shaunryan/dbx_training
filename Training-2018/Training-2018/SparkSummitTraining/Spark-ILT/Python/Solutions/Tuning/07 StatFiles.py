...
# ANSWER
from pyspark.sql.functions import col, lpad, substring_index

partitions =  ["year", "month"]

statFile18DF = (statFileWithPartitions(path2018, partitions, "parquet")
...
partitionsDiffDF = statFile14DF.unionByName(statFile18DF)
