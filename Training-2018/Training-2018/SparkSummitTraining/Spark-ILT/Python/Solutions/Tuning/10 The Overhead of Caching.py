...
# MAGIC 
# MAGIC <img alt="Hint" title="Hint" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.3em" src="https://files.training.databricks.com/static/images/icon-light-bulb.svg"/>&nbsp;**Hint:** Don't close this notebook while you are filling out the worksheet - you will loose any results.
# MAGIC 
...
# MAGIC 
# MAGIC ### What affect does serialization have on performance?
# MAGIC 
# MAGIC ### What is the overhead of MEMROY_ONLY or DISK_ONLY compared to not caching?
# MAGIC 
